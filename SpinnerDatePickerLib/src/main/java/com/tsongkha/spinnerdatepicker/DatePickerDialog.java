 ...
 * tutorial</a>.</p>
 */
public class DatePickerDialog extends AlertDialog implements OnClickListener, DatePicker.OnDateChangedListener {
	...
	DatePickerDialog(Context context, int theme, int spinnerTheme, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth,
